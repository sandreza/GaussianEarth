...
hfile = h5open("/net/fs06/d3/sandre/GaussianEarthData/land_sea_mask.hdf5", "r")
...
save(figure_directory * "climate_change_shifts_hurs_tas_with_data_jan_july_land_sea_"*scenario*".png", fig)
