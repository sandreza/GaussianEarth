...
ax = Axis(fig[1, 2]; title = "Upper Hemisphere Global Average (Emulator)", xlabel = "Month", ylabel = "Temperature (K)", xticks, common_options...)
...
ax = Axis(fig[1, 3]; title = "Lower Hemisphere Global Average (Emulator)", xlabel = "Month", ylabel = "Temperature (K)", xticks, common_options...)
...
save(figure_directory * "climate_change_shifts_monthly_with_upper_lower.png", fig)
